...
import { IDeleteUserInputDTO, IEditUserInputDTO, IGetUsersInputDTO, ILoginInputDTO, ISignupInputDTO, User, USER_ROLES } from "../models/User"
    ...
    public editUser = async (input: IEditUserInputDTO) => {
        ...
        if (payload.role === USER_ROLES.NORMAL) {
            if(payload.id !== idToEdit) {
                throw new Error("Úsuarios normais só podem editar a própria conta");
            }
        }
